...
const orchestrator_1 = require("./utils/orchestrator");
...
async function bootstrapApplication() {
    try {
        ...
        await (0, orchestrator_1.executeSiteAudit)(config.finalUrl, config.runA11y, config.runSeo, config.isHeadless, config.chosenDevice, config.pageCap);
    }
    catch (error) {
