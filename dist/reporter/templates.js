...
exports.renderHistoryRowTemplate = void 0;
exports.renderPageBlockTemplate = renderPageBlockTemplate;
const functional_1 = require("./components/functional");
const a11yDrawer_1 = require("./components/a11yDrawer");
const seoDrawer_1 = require("./components/seoDrawer");
var historyRow_1 = require("./components/historyRow");
Object.defineProperty(exports, "renderHistoryRowTemplate", { enumerable: true, get: function () { return historyRow_1.renderHistoryRowTemplate; } });
function renderPageBlockTemplate(p) {
    ...
    const drawerFunctional = (0, functional_1.compileFunctionalDrawerHtml)(p);
    ...
    if (wasSeoRun) {
        ...
        if (!isDisabledNotice) {
            const drawerSeo = (0, seoDrawer_1.compileSeoDrawerHtml)(p.seoDetails, p.seoPassDetails);
            seoAccordionWrapper = `
