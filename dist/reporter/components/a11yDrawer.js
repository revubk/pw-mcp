...
exports.compileAccessibilityDrawerHtml = compileAccessibilityDrawerHtml;
const a11yCard_1 = require("./a11yCard");
function compileAccessibilityDrawerHtml(a11yDetailsList) {
    ...
    for (const error of a11yDetailsList) {
        ...
        combinedCards += (0, a11yCard_1.renderA11yViolationCard)(error, categoryCountTracker[categoryKey]);
    }
